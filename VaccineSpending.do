...
estpost tabstat enrollment preprimaryenroll year_primary survival_rate  cumulative_survival  unicefmcv1 unicefmcv2 unicefdtp1 unicefdtp3 unicefpol3 lifeexpect pop gdpcap fertility , by(gavi_status_00) statistics(mean sd max min)  
